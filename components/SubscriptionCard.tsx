...
const SubscriptionCard = ({ name, price, currency, icon, billing, color, category, plan, renewalDate, status, expanded,
    startDate, onPress, paymentMethod }: SubscriptionCardProps) => {
